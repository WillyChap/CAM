module physpkg
  ...
  ! Aug 2024    W. Chapman     added the stochastic physics stuff. 
  !-----------------------------------------------------------------------
...
!JDB
    use cam_stoch,          only: cam_stoch_register
!JDB
...
!JDB
    use cam_stoch,          only: cam_stoch_skebs_init, cam_stoch_sppt_init, cam_stoch_conv_init,cam_stoch_sppt
!JDB
